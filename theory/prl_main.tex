...
\cite{suppmat}.  The resulting set spans $s$-, $d$-, $f$-, and
$p$-block cations; Fig.~\ref{fig:pole} shows the 94 species (150
fitted slopes) for which the prediction is finite at $n=4$ and/or
$n=6$.
...
$0.078$~\AA\ for a linear fit against $R_0$ and $0.094$~\AA\ against the
